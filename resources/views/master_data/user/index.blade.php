        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-4 text-end">
                    <a href="{{ route('master_data.user.add') }}" class="btn btn-primary btn-xxs pull-right">
...
<script>
    $('#table-data').DataTable({
      ...
      "bServerSide": true,
      "ajax": {
        "url": "{{ route('master_data.user.list') }}",
        "type": "POST",
        "data": {
            "_token": '{{ csrf_token() }}',
        }
    ...
    function hapus(id) {
      swal({
        ...
        if (result.value) {
          $.get('{{ url("master_data/user/delete") }}/' + id, function(res) {
            swal(
              'Sukses!',
